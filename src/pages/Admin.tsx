  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (allUsers) {
        ...
        // Find user by email — we need the edge function to handle this
        // For now, broadcast or single user via ID
        // Simple approach: use service role in edge function
        payload.all_users = true; // fallback to broadcast for simplicity
      }
