...
const ClubeAccessRevokedEmail = ({ name }: Props) => (
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Seu acesso ao Clube de Estudos está pausado</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Seu acesso ao <strong>Clube de Estudos Dr. Mauro Kwitko</strong> está pausado no momento.
          Isso pode ter acontecido porque a assinatura foi cancelada ou encerrada.
        </Text>
        <Text style={text}>
          Sempre que quiser voltar, é muito simples: basta refazer sua assinatura no botão abaixo.
          Assim que confirmarmos, você volta a acessar todo o conteúdo usando o mesmo e-mail de sempre.
        </Text>
        <Section style={buttonWrap}>
          <Button style={button} href={CHECKOUT_URL}>Voltar para o Clube</Button>
        </Section>
        <Text style={text}>
          Estamos à disposição se precisar de qualquer ajuda.
        </Text>
...
export const template = {
  component: ClubeAccessRevokedEmail,
  subject: 'Seu acesso ao Clube de Estudos está pausado',
  displayName: 'Clube — acesso encerrado',
