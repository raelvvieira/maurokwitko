...
const ClubePaymentOverdueEmail = ({ name }: Props) => (
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Sua mensalidade do Clube está pendente</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Identificamos seu cadastro no <strong>Clube de Estudos Dr. Mauro Kwitko</strong>,
          mas sua última mensalidade ainda não foi confirmada — por isso não conseguimos liberar o acesso agora.
        </Text>
        <Text style={text}>
          Não se preocupe, é simples resolver. Basta clicar no botão abaixo para regularizar
          o pagamento. Assim que ele for confirmado, você volta a acessar todo o conteúdo
          imediatamente, usando o mesmo e-mail.
        </Text>
        <Section style={buttonWrap}>
          <Button style={button} href={CHECKOUT_URL}>Regularizar mensalidade</Button>
        </Section>
        <Text style={text}>
          Se você já fez o pagamento recentemente, aguarde alguns minutos e tente entrar novamente.
        </Text>
...
export const template = {
  component: ClubePaymentOverdueEmail,
  subject: 'Sua mensalidade do Clube está pendente',
  displayName: 'Clube — mensalidade em atraso',
